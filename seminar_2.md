...
* git clone - копирование удаленного репозитория на свой компьютер
* git pull - скачать все из текущего репозитория и сделать слияние с нашей версией
* git push - отправка нашей версии репозитория на удаленный репозиторий

### Pull request
* команда для предложения изменений
* запроз на вливание изменений в репозиторий
